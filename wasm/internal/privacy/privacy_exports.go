...
import (
	...
	// zkp "incognito-chain/privacy/privacy_v1/zeroknowledge"
...
func NewCoinFromPaymentInfo(p *coin.CoinParams) (*CoinV2, *SenderSeal, error) {
...
func NewCoinCA(p *coin.CoinParams, tokenID *common.Hash) (*CoinV2, *operation.Point, *SenderSeal, error) {
