...
const OTAReceiverSerializeAddCheckSumSize = 101;
...
const BurningNearRequestMeta = 337;
const BurningNearForDepositToSCRequestMeta = 338;
const BurningAuroraRequestMeta = 353;
const BurningAuroraForDepositToSCRequestMeta = 357;
const BurningAvaxRequestMeta = 356;
const BurningAvaxForDepositToSCRequestMeta = 358;
...
export {
  ...
  BurningNearForDepositToSCRequestMeta,
  ...
  pdexv3,
  bridgeaggMeta,
  OTAReceiverSerializeAddCheckSumSize,
};
