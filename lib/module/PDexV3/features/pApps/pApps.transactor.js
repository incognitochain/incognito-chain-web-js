...
async function createTransactionPApps(params) {
    try {
        ...
        console.log('createTransactionPApps refundFeeOTA: ', refundFeeOTA)
        if (!refundFeeOTA) {
        ...
        try {
            console.log('createTransactionPApps webAppService: ', this.webAppService)
            console.log('createTransactionPApps submitPayload: ', {
                rawTx,
                refundFeeOTA
            })
            // submit rawTx
            ...
            console.log('createTransactionPApps error: ', refundFeeOTA)
            // update status
