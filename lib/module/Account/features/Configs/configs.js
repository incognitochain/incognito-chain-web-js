...
import { RpcHTTPWebAppServiceClient } from "@lib/rpcclient/rpchttpwebappservice";
...
/**
 * setRPCWebAppService - Set rpc portal services
 * @param {string} url
 */
function setWebAppService(url) {
  new Validator("webAppService", url).required().string();
  this.webAppService = new RpcHTTPWebAppServiceClient(url);
}
