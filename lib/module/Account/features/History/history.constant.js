...
export const STATUS_CODE_SHIELD_REFUND = {
  PENDING: 35, // waiting for requesting
  PROCESSING: 36, // refunding.
  COMPLETE: 37, // refund successful.
  FAILED: 38, // small amount, invalid, not refund
  MERGE: 39, // merged with another record
};
