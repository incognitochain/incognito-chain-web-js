...
export const TX_TYPE = {
  ...
  CONVERT_TO_UNIFIED_TOKEN_REQUEST: 341,
  CONVERT_TO_UNIFIED_TOKEN_RESPONSE: 342
};
...
export const TX_TYPE_STR = {
  ...
  [TX_TYPE.CONVERT_TO_UNIFIED_TOKEN_REQUEST]: "Convert coin request",
  [TX_TYPE.CONVERT_TO_UNIFIED_TOKEN_RESPONSE]: "Convert coin response",
};
...
// NETWORK FEE
export const MAX_FEE_PER_TX = 100000000;

// NETWORK FEE FOR INSCRIPTIONS
export const INSC_MIN_FEE_PER_TX = 10000000000;
export const INSC_MIN_FEE_PER_KB = 1000000000;
...
export const TX_STATUS_STR = {
  [TX_STATUS.PROCESSING]: "Processing",
...
export const META_TYPE = {
  ...
  341: 'Convert coin request',
  342: 'Convert coin response',
...
export const PDEX_TRANSACTION_TYPE = {
  NFT: "NFT",
  ACCESS_ID: "ACCESS_ID",
};

export const DEFAULT_HARDWARE_ACCOUNT_INDEX = 2;
...
export default {
  ...
  DEFAULT_HARDWARE_ACCOUNT_INDEX,
};
