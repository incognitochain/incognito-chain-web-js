...
const ErrorObject = {
  ...
  NotEnoughCoinPRVError: {
    code: -7003,
    description: "Not enough PRV to spend.", // Not enough coin to spend
  },
  ...
  // -30000 -> -30999: PApps error
  CreateOTAFeeError: {
    code: -30000,
    description: "Create OTA fee address error",
  },
  CreateRawDataError: {
    code: -30001,
    description: "Create Raw data error",
  },
};
