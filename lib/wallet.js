...
import { getAddress, getViewKey, getOTAKey } from '../../hw-app-neato/ledger-hw-app';
import { otaKeyAsObject } from "./common/keySet";
...
class Wallet {
  ...
  async initAccountWithHardwareWallet(accountName = "__hw", account, emulator = false) {
    ...
    let t = await (emulator ? TransportHttp(['http://127.0.0.1:9998']).create()
