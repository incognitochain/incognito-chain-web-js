...
function burnForCall(burnAmount, incTokenID, extNetworkID = 1, to, cdata = "", rtoken, raddr = '0x0000000000000000000000000000000000000000') {
    let burningTokenID = this.params.transfer.tokenID;
    this.withTokenID(burningTokenID);
    ...
    if (raddr.startsWith("0x")) raddr = raddr.slice(2);
